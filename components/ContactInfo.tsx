      ...
      <div className="h-full flex flex-col">
        ...
        <div className="p-6 border-b border-gray-100 flex gap-4">
            <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl border border-gray-200 hover:bg-gray-50 hover:border-gray-300 transition-colors text-gray-700 font-medium"
            >
